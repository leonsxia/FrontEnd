    ...
    Promise.all([imageLeft, imageRight]).then((images) => {
        ...
        obstacles.push(new Obstacle([-400, -200], [150, 10], obstacleStyle, obstacleTypes[1]));
    ...
    class Player extends Sprite {
        ...
        checkMovement() {
            if (this.#isMove) {
                if (this.frame % (this.#fasten ? this.fastFrameRate : this.frameRate) === 0) {
                    if (this.sprite === 5) {
                        this.sprite = 0;
                    } else {
                        this.sprite++;
            ...
            if (this.#jump) {
                ...
                let velG = this.velY - this.upEffect * this.gravity * this.elapsedTime
                if (velG > 0 ) { //&& this.posY > -this.jumpMaxHeight
                    this.posY -= velG;
            ...
            } else if (this.bottomY < groundLevel) { // falling
                this.inAirFrame++;
                if (this.inAirFrame % 1 === 0) {
                    this.elapsedTime += this.elapsedMSPerFrame / 1000;
                    // console.log(`${this.elapsedTime}ms`);
