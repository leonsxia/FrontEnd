...
class WorldScene {
    ...
    setupShadowLight(...lights) {
        lights.forEach(light => {
            this.shadowLightObjects.push({
                light: light,
        ...
        this.shadowLightObjects.forEach(lightObj => {
            ...
            this.scene.add(light, lightHelper, lightShadowCamHelper);
            this.attachShadowCamProps(light.shadow.camera);
            this.attachLightHelper(light, lightHelper, lightShadowCamHelper);
            this.addShadow(light);
        });

        // fix when change light position or target, the shadow camera won't update at first frame.
        this.updateMainLightCamera(this.shadowLightObjects);
    }
