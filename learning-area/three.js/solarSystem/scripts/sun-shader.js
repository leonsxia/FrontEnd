...
Sun.prototype.init = function () {
	...
	var uniforms = {
		...
		texture1: { type: "t", value: 0, texture: new THREE.TextureLoader().load(NOISEMAP) },
		texture2: { type: "t", value: 1, texture: new THREE.TextureLoader().load(SUNMAP) }
	...
	let sunMesh = new THREE.Mesh(geometry, material);
